...
def main():
    ...
    initial_pose.pose.position.y = -0.56
    initial_pose.pose.orientation.z = -0.0015
    ...
    goal_pose1.pose.position.x = -0.61
    goal_pose1.pose.position.y = 1.72
    ...
    goal_pose2.pose.position.x = 1.66
    goal_pose2.pose.position.y = -0.48
    ...
    goal_pose3.pose.position.x = -0.1
    goal_pose3.pose.position.y = -1.83
    ...
    while not navigator.isTaskComplete():
        ...
        if feedback and i % 5 == 0:
            ...
            if Duration.from_msg(feedback.navigation_time) > Duration(seconds=35.0):
                ...
                goal_pose4.pose.position.x = -2.21
                goal_pose4.pose.position.y = 0.02
